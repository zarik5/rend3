...
fn main_1() {
    ...
    let _e460 = phi_2651_;
    let _e462 = phi_2627_;
    let _e464 = vec3<f32>(0.0,0.0,0.0);// phi_2599_;
    let _e466 = phi_2588_;
    let _e468 = phi_2500_;
                            ...
                            (
                                ...
                                (
                                    (
                                            ...
                                            (
                                                (
                                                    vec3<f32>(0.0,0.0,0.0
                                                        // clamp(
                                                        //     dot(_e464, vec3<f32>(16.5, 16.5, 16.5)),
                                                        //     0.0, 
                                                        //     1.0
                                                        // )
                                                    )
                                                ...
                                                *
                                                pow(
                                                    (1.0 - clamp(dot(_e554, _e556), 0.0, 1.0)), 
                                                    5.0
                                                )
                                            )
                                        )
                                        *
                                        (
                                            (_e568 / ((3.1415927410125732 * _e572) * _e572))
                                            *
                                            (
                                                0.5
                                                /
                                                    ...
                                                    (
                                                        _e561 * sqrt(
                                                            (
                                                                (
                                                                    (
                                                                        ((-9.999999747378752e-6 - _e558) * _e568)
                                                                        +
                                                                        _e559
                                                                    )
                                                                    * _e559
